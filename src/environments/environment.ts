...
export const environment = {
  ...
  loginURL:
    'https://testing-login.auth.ap-northeast-1.amazoncognito.com/oauth2/authorize?client_id=33add8eps5jiu29cu764dae0bs&response_type=code&scope=aws.cognito.signin.user.admin+openid+profile&redirect_uri=http%3A%2F%2Flocalhost%3A4200%2Fdashboard',
